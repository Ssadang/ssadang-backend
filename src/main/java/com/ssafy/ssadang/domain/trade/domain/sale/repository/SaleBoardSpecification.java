...
public class SaleBoardSpecification {
	...
	public static Specification<SaleBoard> hasAllKeywordsIn(String[] keywords, List<ItemCategory> itemCategories) {
	...
	public static Specification<SaleBoard> isCreateDateLessThanAndHasAllKeywordsIn(
